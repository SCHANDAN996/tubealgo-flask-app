...
def initialize_ai_clients():
    ...
    if gemini_keys_str:
        try:
            ...
            # Fallback for comma-separated string for backward compatibility
...
def get_next_gemini_client():
    ...
    try:
        ...
        print(f"INFO: Using Gemini key ending in ...{key_to_use[-4:]} with model {selected_model_name}")
        return model
...
# ... (get_ai_video_suggestions and generate_titles_and_tags functions remain unchanged) ...
...
def generate_description(user, topic, title, language='English'):
    # यूजर की सेव की गई जानकारी को इकट्ठा करें
    ...
    if not has_defaults:
        defaults_context = "" # अगर कोई जानकारी नहीं है, तो कॉन्टेक्स्ट खाली रखें
...
# ... (generate_motivational_suggestion and generate_playlist_suggestions functions remain unchanged) ...
